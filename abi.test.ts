import Web3x4 from '../web3.js/packages/web3/dist'
...
describe('abi', () => {
    ...
    it('decodeParameter v3', () => {
        ...
        expect(res1['0']).toEqual(res4['0'])
        expect(res1['1']).toEqual(res4['1'])
        expect(res4).toEqual({
                '0': '42',
                '1': '56',
                '2': { '0': '45', '1': '78', propertyOne: '45', propertyTwo: '78' },
                propertyOne: '42',
                propertyTwo: '56',
                childStruct: { '0': '45', '1': '78', propertyOne: '45', propertyTwo: '78' }
            }
        )
    })
    it('decodeParameters', () => {
        ...
        expect(res4).toEqual({"0": "Hello!%!", "1": "234", "__length__": 2})
    })
    ...
    it('decodeParameters v3', () => {
        ...
        const res4 = web3x4.eth.abi.decodeParameters(param1, param2) as any
        const res1 = web3x1.eth.abi.decodeParameters(param1, param2) as any
        expect(res1['0']).toEqual(res4['0'])
        expect(res4).toEqual({
                '0': [ '42', '24' ],
                '1': {
